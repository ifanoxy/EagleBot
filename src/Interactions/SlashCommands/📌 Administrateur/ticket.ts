...
export default {
    ...
    async autocomplete(interaction, client) {
        ...
        await interaction.respond(
            filtered.map(choice => ({ name: `${choice} | ${userData.data[choice].map(x => x.name.slice(0, 20)+"...").join(" / ")}`, value: choice })),
        );
    },
        ...
        switch (interaction.options.getSubcommand()) {
            case "setup" : {
                ...
                interaction.reply({
                    ...
                    components: [
                        new ActionRowBuilder<ButtonBuilder>().addComponents(startButton, cancelButton)
                    ],
                    ephemeral: true,
                }).then(msg => {
                            ...
                            ask(
                                ...
                                .then(inter2 => {
                                    ...
                                    ask(
                                        ...
                                        [
                                            new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(selectMenuChoix)
                                        ],
                                        inter2,
                                                    ...
                                                    await interactionNow.update({
                                                        ...
                                                        .then(msg => {
                                                            return msg.awaitMessageComponent({
                                                                ...
                                                                .catch(reason => {msg.components.map(row => row.components.map(component => component.data.disabled = true))
