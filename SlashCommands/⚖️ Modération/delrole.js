...
module.exports = {
    ...
    .setName("del-role")
    .setDescription("Permet de retirer un rôle à un membre")
    .setDMPermission(false)
    .addUserOption(
        opt => opt.setName("membre").setDescription("le membre dont vous souhaitez retirer le role").setRequired(true)
    )
    .addRoleOption(
        opt => opt.setName('role').setDescription('le role que vous souhaitez retirer au membre').setRequired(true)
    ),
    /**
     * 
