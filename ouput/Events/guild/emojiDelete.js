...
exports.default = {
    ...
    execute(client, emoji) {
        ...
        if (!((_b = (_a = AntiraidData === null || AntiraidData === void 0 ? void 0 : AntiraidData.status["anti-massEmoji"]) === null || _a === void 0 ? void 0 : _a.delete) === null || _b === void 0 ? void 0 : _b.status))
    ...
    antiraid(AntiraidData, channel, client) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const AuditLog = yield channel.guild.fetchAuditLogs({ limit: 1, type: discord_js_1.AuditLogEvent.EmojiDelete });
            ...
            if (((frequenceData === null || frequenceData === void 0 ? void 0 : frequenceData.emojiDelete) || 0) < maxfrequence - 1) {
                frequenceData.emojiDelete = ((frequenceData === null || frequenceData === void 0 ? void 0 : frequenceData.emojiDelete) || 0) + 1;
            ...
            yield client.func.mod.applySanction(member[0], AntiraidData.status["anti-massEmoji"].delete.sanction, AntiraidData, "Mass Channel Delete");
            frequenceData === null || frequenceData === void 0 ? true : delete frequenceData.emojiDelete;
            client._fs.writeFileSync(`./AntiRaid/frequence/${userId}.json`, JSON.stringify(frequenceData));
        });
    }
};
