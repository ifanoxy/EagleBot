...
exports.default = {
    ...
    execute(client, channel) {
        ...
        if (!((_b = (_a = AntiraidData === null || AntiraidData === void 0 ? void 0 : AntiraidData.status["anti-massChannel"]) === null || _a === void 0 ? void 0 : _a.create) === null || _b === void 0 ? void 0 : _b.status))
            ...
            channelSend.send({
                embeds: [
                    new discord_js_1.EmbedBuilder().setColor("#2f3136").setTimestamp()
                        ...
                        `**Créé par:** <@${(_a = audit.entries.first()) === null || _a === void 0 ? void 0 : _a.executor.id}>`)
                ]
            });
        });
    },
    antiraid(AntiraidData, channel, client) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const AuditLog = yield channel.guild.fetchAuditLogs({ limit: 1, type: discord_js_1.AuditLogEvent.ChannelCreate });
            ...
            if (((frequenceData === null || frequenceData === void 0 ? void 0 : frequenceData.channelCreate) || 0) < maxfrequence - 1) {
                frequenceData.channelCreate = ((frequenceData === null || frequenceData === void 0 ? void 0 : frequenceData.channelCreate) || 0) + 1;
            ...
            yield client.func.mod.applySanction(member[0], AntiraidData.status["anti-massChannel"].create.sanction, AntiraidData, "Mass Channel Create");
            frequenceData === null || frequenceData === void 0 ? true : delete frequenceData.channelCreate;
            client._fs.writeFileSync(`./AntiRaid/frequence/${userId}.json`, JSON.stringify(frequenceData));
        });
    }
};
