...
exports.default = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .addUserOption(option => option.setName("utilisateur").setDescription("entrez l'utilisateur que vous shouaitez whitelist").setRequired(true))
        .addStringOption(opt => opt.setName("raison").setDescription("La raison pour laquel vous voulez whitelist ce membre")),
    execute(interaction, client) {
        const id = interaction.options.getUser("utilisateur").id;
        if (client.isWhitelist(id))
