...
exports.default = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName("utilisateur").setDescription("entrez la personne que vous shouaitez unwhitelist").setRequired(true).setAutocomplete(true)),
